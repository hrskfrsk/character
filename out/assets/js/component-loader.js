...
class ComponentLoader {
  ...
  initializeComponentEvents(element) {
    ...
    // equipmentコンポーネントの場合は状態復元を実行
    if (element.id === 'equipment-section' && typeof window.restoreEquipmentSectionStates === 'function') {
      setTimeout(() => {
        console.log('Attempting to restore equipment section states...');
        window.restoreEquipmentSectionStates();
      }, 500);
    }
  }
